...
return $textBox1.Text, $textBox2.Text, $textBox3.Text, $textBox4.Text, $textBox5.Text, $textBox6.Text, $textBox7.Text, $textBox8.Text, $DropDownBox.Text
}
 
$return= button “FHCRC EC2 Server Request Form - Windows” “Host name*” “Owner*(_adm/solarch)” “Tech Contact*(user@fredhutch.org)” “Billing Contact*(user@fredhutch.org)” "Password" "Root Volume Size (GB)" "PHI (Yes,No)" "PII (Yes, No)" "Instance Type"
...
##O:\scripts\aws
.\ec2-provision-instance.ps1 -Name $Name -Owner $Owner -TechContact $TechContact -BillingContact $BillingContact -InstanceType $InstanceType -Password $Password -RootVolSize $RootVolSize -Phi $Phi -Pii $Pii
